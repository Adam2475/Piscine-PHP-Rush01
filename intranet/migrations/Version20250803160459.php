 ...
 */
final class Version20250803160459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD name VARCHAR(100) NOT NULL, ADD description LONGTEXT NOT NULL, ADD xp INT NOT NULL, ADD estimated_time_in_hours INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project DROP name, DROP description, DROP xp, DROP estimated_time_in_hours');
    }
}
