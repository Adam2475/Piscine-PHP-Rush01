 ...
 */
final class Version20250805142835 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project_evaluation_request (id INT AUTO_INCREMENT NOT NULL, requester_id INT NOT NULL, evaluator_id INT DEFAULT NULL, project_id INT NOT NULL, eval_slot_id INT DEFAULT NULL, validated TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, evaluated_at DATETIME DEFAULT NULL, INDEX IDX_AED66974ED442CF4 (requester_id), INDEX IDX_AED6697443575BE2 (evaluator_id), INDEX IDX_AED66974166D1F9C (project_id), INDEX IDX_AED66974114E77B1 (eval_slot_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(60) NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(100) DEFAULT NULL, created DATE NOT NULL, role VARCHAR(255) NOT NULL, confirmation_token VARCHAR(64) DEFAULT NULL, is_active TINYINT(1) NOT NULL, image LONGTEXT DEFAULT NULL, experience INT DEFAULT 0 NOT NULL, eval_points INT NOT NULL, notifications JSON DEFAULT NULL, unread_notifications_count INT DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649C05FB297 (confirmation_token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_project (user_id INT NOT NULL, project_id INT NOT NULL, validated_by_id INT DEFAULT NULL, validated TINYINT(1) NOT NULL, uploaded_file_path VARCHAR(255) DEFAULT NULL, INDEX IDX_77BECEE4A76ED395 (user_id), INDEX IDX_77BECEE4166D1F9C (project_id), INDEX IDX_77BECEE4C69DE5E5 (validated_by_id), PRIMARY KEY(user_id, project_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE project_evaluation_request ADD CONSTRAINT FK_AED66974114E77B1 FOREIGN KEY (eval_slot_id) REFERENCES eval_slot (id)');
