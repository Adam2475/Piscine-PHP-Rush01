...
class ChatController extends AbstractController
{
    ...
    public function projectChat(int $projectId, ProjectRepository $projectRepo, ChatMessageRepository $chatRepo): Response
    {
        $user = $this->getUser();
    ...
    public function sendMessage(Request $request, EntityManagerInterface $em, UserRepository $userRepo, ProjectRepository $projectRepo): JsonResponse
    {
        $user = $this->getUser();
    ...
    public function getProjectMessages(int $projectId, ProjectRepository $projectRepo, ChatMessageRepository $chatRepo): JsonResponse
    {
        $user = $this->getUser();
        $project = $projectRepo->find($projectId);
